...
class Settings extends Admin_Controller
{
	...
	private function save_settings($extended_settings=array())
	{
		...
		$data = array(
			...
			array('name' => 'site.kasubkpu', 'value' => $this->input->post('kasubkpu')),
			array('name' => 'site.persediaan', 'value' => $this->input->post('persediaan')),
			array('name' => 'site.pengadaan', 'value' => $this->input->post('pengadaan')),
			array('name' => 'site.bmn', 'value' => $this->input->post('bmn')),
			array('name' => 'site.maxmasuk', 'value' => $this->input->post('maxmasuk')),
			array('name' => 'site.maxpulang', 'value' => $this->input->post('maxpulang')),
			
			array('name' => 'site.kinerja', 'value' => $this->input->post('kinerja')),
			array('name' => 'site.kehadiran', 'value' => $this->input->post('kehadiran')),
			//files
			array('name' => 'site.pathuploaded', 'value' => $this->input->post('pathuploaded')),
			array('name' => 'site.urluploaded', 'value' => $this->input->post('urluploaded')),
