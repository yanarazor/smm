				...
				<div class="tab-pane active" id="main-settings">
					...
					<fieldset>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="kasubkpu" id="KPU" class="span4" value="<?php echo set_value('site.kasubkpu', isset($settings['site.kasubkpu']) ? $settings['site.kasubkpu'] : '') ?>" />
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="title">Persediaan</label>
							<div class="controls">
								<input type="text" name="persediaan" id="persediaan" class="span4" value="<?php echo set_value('site.persediaan', isset($settings['site.persediaan']) ? $settings['site.persediaan'] : '') ?>" />
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="title">Pengadaan</label>
							<div class="controls">
								<input type="text" name="pengadaan" id="pengadaan" class="span4" value="<?php echo set_value('site.pengadaan', isset($settings['site.pengadaan']) ? $settings['site.pengadaan'] : '') ?>" />
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="title">BMN</label>
							<div class="controls">
								<input type="text" name="bmn" id="bmn" class="span4" value="<?php echo set_value('site.bmn', isset($settings['site.bmn']) ? $settings['site.bmn'] : '') ?>" />
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="title">Max Jam Masuk Kerja</label>
							<div class="controls">
								<input type="text" name="maxmasuk" id="maxmasuk"  class="timeformat" value="<?php echo set_value('site.maxmasuk', isset($settings['site.maxmasuk']) ? $settings['site.maxmasuk'] : '') ?>" />
								<p class="help-inline">Isi dengan maksimal jam masuk, ()</p>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="title">Min Jam Pulang Kerja</label>
							<div class="controls">
								<input type="text" name="maxpulang" id="maxpulang"  class="timeformat" value="<?php echo set_value('site.maxmasuk', isset($settings['site.maxpulang']) ? $settings['site.maxpulang'] : '') ?>" />
								<p class="help-inline">Isi dengan minimal jam Pulang, (16:00:00)</p>
							</div>
						</div>
					</fieldset>
				</div>
