	...
	private function autologin()
	{
		...
		if ($query->num_rows() == 1)
		{
			...
			if ( ! $this->ci->session->userdata('user_id'))
			{
				...
				$this->setup_session($user->id, $user->username, $user->password_hash, $user->email, $user->role_id, TRUE, $test_token, $user->username, $user->atasan, $user->id_bidang, $user->id_sub_bidang);
			}
		}
