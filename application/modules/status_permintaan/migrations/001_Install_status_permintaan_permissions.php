...
class Migration_Install_status_permintaan_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Status_Permintaan.Masters.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Status_Permintaan.Masters.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Status_Permintaan.Masters.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Status_Permintaan.Masters.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
