	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/kepegawaian/sppd/periksa/' . $record->id, '<span class="icon-pencil"></span>' .  $record->nama); ?></td>
				<?php else : ?>
				...
				?>
				<tr>
					<td colspan="12">No records found that match your selection.</td>
				</tr>
				<?php endif; ?>
			</tbody>
		</table>
