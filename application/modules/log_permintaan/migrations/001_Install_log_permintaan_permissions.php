...
class Migration_Install_log_permintaan_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Log_permintaan.Reports.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Log_permintaan.Reports.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Log_permintaan.Reports.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
