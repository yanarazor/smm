...
class Migration_Install_daftar_periksa_audit_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Daftar_Periksa_Audit.Audit.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Daftar_Periksa_Audit.Audit.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Daftar_Periksa_Audit.Audit.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Daftar_Periksa_Audit.Audit.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
