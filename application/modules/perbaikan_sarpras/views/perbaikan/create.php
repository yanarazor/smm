...
<div class="admin-box">
	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal" id="frminput"'); ?>
		...
		<div class="alert alert-block alert-warning fade in">
		   ...
		   Gedung dan bangunan : Gedung,Listrik, Air <br>
		   Peralatan Komputer dan jaringan : Komputer, printer, scanner, jaringan <br>
		   Peralatan dan Mesin : Meja, Kursi, Lemari, AC, Telepon, Kendaraan dinas 
			...
			<div class="control-group <?php echo form_error('nomor') ? 'error' : ''; ?>">
				...
				<div class='controls'>
					<input id='perbaikan_sarpras_nomor' readonly='true' class="validate[required] text-input"  type='text' name='perbaikan_sarpras_nomor' maxlength="10" value="<?php echo set_value('perbaikan_sarpras_nomor', isset($noauto) ? $noauto : ''); ?>" />
			...
			<div class="control-group <?php echo form_error('nomor_inventaris') ? 'error' : ''; ?>">
				...
				<div class='controls'>
					<input id='perbaikan_sarpras_nomor_inventaris' type='text' class="validate[required] text-input" name='perbaikan_sarpras_nomor_inventaris' maxlength="20" value="<?php echo set_value('perbaikan_sarpras_nomor_inventaris', isset($perbaikan_sarpras['nomor_inventaris']) ? $perbaikan_sarpras['nomor_inventaris'] : '3.'); ?>" />
			...
			<div class="control-group <?php echo form_error('merek') ? 'error' : ''; ?>">
				<?php echo form_label('Merek/Type', 'merek', array('class' => 'control-label') ); ?>
				<div class='controls'>
					<input id='merek' type='text' name='merek' maxlength="50" class="validate[required] text-input" value="<?php echo set_value('merek', isset($perbaikan_sarpras['merek']) ? $perbaikan_sarpras['merek'] : ''); ?>" />
			...
			<div class="form-actions">
				<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('perbaikan_sarpras_action_create'); ?>"  />
				<?php echo lang('bf_or'); ?>
