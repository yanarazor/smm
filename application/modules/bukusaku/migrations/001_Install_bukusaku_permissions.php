...
class Migration_Install_bukusaku_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Bukusaku.Logbook.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Bukusaku.Logbook.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Bukusaku.Logbook.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Bukusaku.Logbook.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
