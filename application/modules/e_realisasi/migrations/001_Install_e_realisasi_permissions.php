...
class Migration_Install_e_realisasi_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'E_Realisasi.Realisasi.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'E_Realisasi.Realisasi.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'E_Realisasi.Realisasi.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'E_Realisasi.Realisasi.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
