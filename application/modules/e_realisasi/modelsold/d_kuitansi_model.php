...
class d_kuitansi_model extends BF_Model {
	...
	public function find_allrakakl($nokwt = "",$kdkmpnen = "",$kdskmpnen="",$kdsoutput = "")
	{
		if (empty($this->selects))
		{
		...
		$this->db->join('saskuitansi_rkakl r', 'r.nokwt = sasdd_kuitansi.nokwt and r.kdoutput = bf_sasdd_kuitansi.kdoutput and r.kdsoutput = bf_sasdd_kuitansi.kdsoutput and r.kdkmpnen = bf_sasdd_kuitansi.kdkmpnen and r.kdskmpnen = bf_sasdd_kuitansi.kdskmpnen', 'left'); 
		$this->db->order_by("tglkwt","desc");
