...
class kuitansi_rkakl_model extends BF_Model {

	protected $table_name	= "saskuitansi_rkakl";
	protected $key			= "id";
	...
	//--------------------------------------------------------------------
	public function find_all($nokwt = "",$kdkmpnen = "",$kdskmpnen="",$kdsoutput = "")
	{
