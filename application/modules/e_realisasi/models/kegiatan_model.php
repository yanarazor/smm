...
class Kegiatan_model extends BF_Model {
	...
	public function getdistinctkegiatan($kdkmpnen = "",$kdskmpnen="",$kdsoutput = "",$tahun = "")
	{
		if (empty($this->selects))
		{
			$this->select('TRIM(bf_sasd_skmpnen.kdkmpnen) as kdkmpnen,
				nmoutput,TRIM(bf_sasd_skmpnen.kdskmpnen) as kdskmpnen,
				TRIM(bf_sasd_skmpnen.urskmpnen) as urskmpnen,
				trim(bf_sasd_soutput.kdoutput) as kdoutput,
				sasd_soutput.kdsoutput,
				sasd_kmpnen.urkmpnen,ursoutput,
				sasd_soutput.kdgiat');
		}
		if($kdkmpnen != ""){
			$this->db->where('trim(bf_sasd_skmpnen.kdkmpnen)',$kdkmpnen);
		...
		$this->db->group_by("sasd_skmpnen.kdgiat");
		$this->db->group_by("sasd_skmpnen.kdoutput");
		$this->db->group_by("sasd_skmpnen.kdsoutput");
		$this->db->group_by("sasd_skmpnen.kdkmpnen");
		$this->db->group_by("sasd_skmpnen.kdskmpnen");
		...
		$this->db->join('sast_output t', 'bf_sasd_skmpnen.kdgiat = t.kdgiat and bf_sasd_skmpnen.kdoutput = t.kdoutput', 'left'); 
		$this->db->join('sasd_kmpnen', 'bf_sasd_kmpnen.kdkmpnen = sasd_skmpnen.kdkmpnen and bf_sasd_kmpnen.kdoutput = bf_sasd_skmpnen.kdoutput', 'inner'); 
		$this->db->join('sasd_soutput', 'sasd_soutput.thang = bf_sasd_kmpnen.thang and bf_sasd_soutput.kdgiat = bf_sasd_kmpnen.kdgiat and bf_sasd_soutput.kdoutput = bf_sasd_kmpnen.kdoutput and bf_sasd_soutput.kdsoutput = bf_sasd_kmpnen.kdsoutput', 'inner'); 
		//$this->db->distinct();

		$this->db->order_by("sasd_skmpnen.kdgiat","asc");
		$this->db->order_by("sasd_skmpnen.kdoutput","asc");
