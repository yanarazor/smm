...
class Migration_Install_master_izin_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Master_Izin.Masters.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Master_Izin.Masters.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Master_Izin.Masters.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Master_Izin.Masters.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
