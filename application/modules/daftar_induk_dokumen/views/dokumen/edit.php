...
<div class="admin-box">
	...
	<?php echo form_open_multipart($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<div class="control-group <?php echo form_error('sub_bidang') ? 'error' : ''; ?>">
				<?php echo form_label('Sub Bidang'. lang('bf_form_label_required'), 'sub_bidang', array('class' => 'control-label') ); ?>
				<div class='controls'>
                	<select name="sub_bidang" id="sub_bidang" class="chosen-select-deselect">
						<option value="">-- Pilih  --</option>
						<?php if (isset($sub_bidangs) && is_array($sub_bidangs) && count($sub_bidangs)):?>
						<?php foreach($sub_bidangs as $sub_bidang):?>
							<option value="<?php echo $sub_bidang->id?>" <?php if(isset($daftar_induk_dokumen['sub_bidang']))  echo  ($sub_bidang->id==$daftar_induk_dokumen['sub_bidang']) ? "selected" : ""; ?>> <?php e(ucfirst($sub_bidang->nama_subbid)); ?></option>
							<?php endforeach;?>
						<?php endif;?>
					</select>
					<span class='help-inline'><?php echo form_error('sub_bidang'); ?></span>
				</div>
			</div>
...
-->
			...
			<div class="form-actions">
				...
				<?php if ($this->auth->has_permission('Daftar_Induk_Dokumen.Dokumen.Delete')) : ?>
				or
				<button type="submit" name="delete" class="btn btn-danger" id="delete-me" onclick="return confirm('<?php e(js_escape("Daftar Induk Dokumen")); ?>'); ">
					<span class="icon-trash icon-white"></span>&nbsp;<?php echo lang('daftar_induk_dokumen_delete_record'); ?>
				</button>
			<?php endif; ?>
