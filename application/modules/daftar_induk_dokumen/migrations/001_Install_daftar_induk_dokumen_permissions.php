...
class Migration_Install_daftar_induk_dokumen_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Daftar_Induk_Dokumen.Dokumen.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Daftar_Induk_Dokumen.Dokumen.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Daftar_Induk_Dokumen.Dokumen.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Daftar_Induk_Dokumen.Dokumen.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
