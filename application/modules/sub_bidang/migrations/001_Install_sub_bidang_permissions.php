...
class Migration_Install_sub_bidang_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Sub_Bidang.Masters.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Sub_Bidang.Masters.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Sub_Bidang.Masters.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Sub_Bidang.Masters.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
