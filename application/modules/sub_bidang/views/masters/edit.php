...
<div class="admin-box">
	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<div class="control-group <?php echo form_error('nama_subbid') ? 'error' : ''; ?>">
				...
				<div class='controls'>
					...
					<span class='help-inline'><?php echo form_error('nama_subbid'); ?></span>
				</div>
			</div>
			...
			<div class="form-actions">
				<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('sub_bidang_action_edit'); ?>"  />
				<?php echo lang('bf_or'); ?>
				<?php echo anchor(SITE_AREA .'/masters/sub_bidang', lang('sub_bidang_cancel'), 'class="btn btn-warning"'); ?>
				
			<?php if ($this->auth->has_permission('Sub_Bidang.Masters.Delete')) : ?>
				or
				<button type="submit" name="delete" class="btn btn-danger" id="delete-me" onclick="return confirm('<?php e(js_escape(lang('sub_bidang_delete_confirm'))); ?>'); ">
					<span class="icon-trash icon-white"></span>&nbsp;<?php echo lang('sub_bidang_delete_record'); ?>
				</button>
			<?php endif; ?>
			</div>
		</fieldset>
