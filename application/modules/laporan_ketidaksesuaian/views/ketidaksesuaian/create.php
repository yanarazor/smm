...
-->
			...
			<div class="control-group <?php echo form_error('laporan_ketidaksesuaian_bidang_bagian') ? 'error' : ''; ?>">
				<?php echo form_label('Bidang'. lang('bf_form_label_required'), 'laporan_ketidaksesuaian_bidang_bagian', array('class' => 'control-label') ); ?>
				<div class='controls'>
			...
			<div class="control-group <?php echo form_error('laporan_ketidaksesuaian_keputusan') ? 'error' : ''; ?>">
				...
				<div class='controls'>
						...
						<?php foreach($tindakans as $tindakan):?>
                        	<label class='radio'>
							<input id='laporan_ketidaksesuaian_status_evaluasi_swm_option1' name='laporan_ketidaksesuaian_status_evaluasi_swm' type='radio' value='1' <?php if(isset($laporan_ketidaksesuaian['keputusan'])){ echo $laporan_ketidaksesuaian['keputusan']==$tindakan->id ? "checked" : ""; } ?> <?php echo set_radio('laporan_ketidaksesuaian_keputusan', '1'); ?> />
					...
					<span class='help-inline'><?php echo form_error('laporan_ketidaksesuaian_keputusan'); ?></span>
				</div>
			</div> 
