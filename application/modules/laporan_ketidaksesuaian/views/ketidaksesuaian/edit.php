...
-->
			...
			<div class="control-group <?php echo form_error('laporan_ketidaksesuaian_bidang_bagian') ? 'error' : ''; ?>">
				...
				<div class='controls'>
					...
					<span class='help-inline'><?php echo form_error('laporan_ketidaksesuaian_bidang_bagian'); ?></span>
				</div>
			</div>
            ...
            <?php if(isset($laporan_ketidaksesuaian['status_evaluasi_swm'])){
			?>	
            	<fieldset>
				...
				<div class="control-group <?php echo form_error('laporan_ketidaksesuaian_status_evaluasi_swm') ? 'error' : ''; ?>">
					...
					<div class='controls'> 
						<label class='radio' for='laporan_ketidaksesuaian_status_evaluasi_swm_option1'>
							<input id='laporan_ketidaksesuaian_status_evaluasi_swm_option1' name='laporan_ketidaksesuaian_status_evaluasi_swm' type='radio' value='1' <?php if(isset($laporan_ketidaksesuaian['status_evaluasi_swm'])){ if($laporan_ketidaksesuaian['status_evaluasi_swm']=="1" ) echo "checked"; } ?>/>
							Setuju (Kirim ke Penanggung Jawab)
						</label>
						</br>
						<label class='radio' for='laporan_ketidaksesuaian_status_evaluasi_swm_option2'>
							<input id='laporan_ketidaksesuaian_status_evaluasi_swm_option2' name='laporan_ketidaksesuaian_status_evaluasi_swm' type='radio' value='0' <?php if(isset($laporan_ketidaksesuaian['status_evaluasi_swm'])){ echo $laporan_ketidaksesuaian['status_evaluasi_swm']=="0" ? "checked" : ""; }  ?>/>
							Tidak Setuju
						</label>
