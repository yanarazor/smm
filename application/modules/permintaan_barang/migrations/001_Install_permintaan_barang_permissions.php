...
class Migration_Install_permintaan_barang_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Permintaan_Barang.Permintaanbarang.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Permintaan_Barang.Permintaanbarang.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Permintaan_Barang.Permintaanbarang.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Permintaan_Barang.Permintaanbarang.Delete',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Permintaan_Barang.Reports.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Permintaan_Barang.Reports.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Permintaan_Barang.Reports.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Permintaan_Barang.Reports.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
