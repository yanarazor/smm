...
$can_edit		= $this->auth->has_permission('Permintaan_Barang.Permintaanbarang.persediaan');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/permintaanbarang/permintaan_barang/verps/' . $record->id, '<span class="icon-pencil"></span>' .  $record->nomor); ?></td>
				<?php else : ?>
