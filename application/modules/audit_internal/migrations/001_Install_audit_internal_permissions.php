...
class Migration_Install_audit_internal_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Audit_Internal.Audit.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Audit_Internal.Audit.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Audit_Internal.Audit.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Audit_Internal.Audit.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
