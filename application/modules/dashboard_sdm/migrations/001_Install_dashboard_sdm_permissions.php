...
class Migration_Install_dashboard_sdm_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Dashboard_Sdm.Reports.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Dashboard_Sdm.Reports.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Dashboard_Sdm.Reports.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Dashboard_Sdm.Reports.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
