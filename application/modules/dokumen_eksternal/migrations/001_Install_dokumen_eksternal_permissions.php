...
class Migration_Install_dokumen_eksternal_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Dokumen_Eksternal.Dokumen.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Dokumen_Eksternal.Dokumen.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Dokumen_Eksternal.Dokumen.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Dokumen_Eksternal.Dokumen.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
