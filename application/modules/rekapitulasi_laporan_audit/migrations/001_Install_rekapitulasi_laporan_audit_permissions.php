...
class Migration_Install_rekapitulasi_laporan_audit_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Rekapitulasi_Laporan_Audit.Audit.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Rekapitulasi_Laporan_Audit.Audit.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Rekapitulasi_Laporan_Audit.Audit.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Rekapitulasi_Laporan_Audit.Audit.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
