...
-->
			<div class="control-group <?php echo form_error('no_ptpp') ? 'error' : ''; ?>">
				...
				<div class='controls'>
					<input id='daftar_ptpp_diajukan_oleh' type='hidden' name='daftar_ptpp_diajukan_oleh' maxlength="50" value="<?php echo set_value('daftar_ptpp_diajukan_oleh', isset($daftar_ptpp['diajukan_oleh']) ? $daftar_ptpp['diajukan_oleh'] : ''); ?>" />
