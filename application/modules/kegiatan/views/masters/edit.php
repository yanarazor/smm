	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<div class="control-group <?php echo form_error('kode') ? 'error' : ''; ?>">
				...
				<div class='controls'>
					<input id='kegiatan_kode' type='text' name='kegiatan_kode' maxlength="100" value="<?php echo set_value('kegiatan_kode', isset($kegiatan['kode']) ? $kegiatan['kode'] : ''); ?>" />
			...
			<?php if ($this->auth->has_permission('Kegiatan.Masters.Delete')) : ?>
				or
				<button type="submit" name="delete" class="btn btn-danger" id="delete-me" onclick="return confirm('<?php e(js_escape(lang('kegiatan_delete_confirm'))); ?>'); ">
					<span class="icon-trash icon-white"></span>&nbsp;<?php echo lang('kegiatan_delete_record'); ?>
				</button>
			<?php endif; ?>
			</div>
		</fieldset>
