...
class Migration_Install_kegiatan_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Kegiatan.Masters.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Kegiatan.Masters.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Kegiatan.Masters.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Kegiatan.Masters.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
