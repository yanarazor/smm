...
$convert = new convert();
$num_columns	= 16;
$can_delete	= $this->auth->has_permission('SPPD_Jabodetabek.Kepegawaian.Delete');
$can_edit		= $this->auth->has_permission('SPPD_Jabodetabek.Kepegawaian.Edit');
		...
		<table class="table table-striped">
			<thead>
				<tr>
					...
					<th>Jam Berangkat</th>
					<th>Nama Pengemudi Nomor Kendaraan</th>
					<th>Pengikut</th>
					<th>Status</th>
				</tr>
			</thead>
			...
			<tfoot>
				...
				<tr>
					<td colspan="<?php echo $num_columns; ?>">
						...
						<input type="submit" name="delete" id="delete-me" class="btn btn-danger" value="<?php echo lang('bf_action_delete'); ?>" onclick="return confirm('<?php e(js_escape(lang('sppd_jabodetabek_delete_confirm'))); ?>')" />
					</td>
				</tr>
				<?php endif; ?>
			</tfoot>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/kepegawaian/sppd_jabodetabek/periksa/' . $record->id, '<span class="icon-pencil"></span>' .  $record->nama); ?></td>
				<?php else : ?>
				...
				<?php endif; ?>
					...
					<td><?php e($record->pengemudi) ?></td>
					<td><?php echo $record->pengikut; ?></td>
					<td>
						<?php 
