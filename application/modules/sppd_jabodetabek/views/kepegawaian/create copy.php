	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<div class="control-group <?php echo form_error('tanggal_berangkat') ? 'error' : ''; ?>">
				<?php echo form_label('Tanggal Berangkat', 'sppd_jabodetabek_tanggal_berangkat', array('class' => 'control-label') ); ?>
				<div class='controls'>
					<input id='sppd_jabodetabek_tanggal_berangkat'  type='text' name='sppd_jabodetabek_tanggal_berangkat'  value="<?php echo set_value('sppd_jabodetabek_tanggal_berangkat', isset($sppd_jabodetabek['tanggal_berangkat']) ? $sppd_jabodetabek['tanggal_berangkat'] : ''); ?>" />
			...
			<div class="control-group <?php echo form_error('pengikut') ? 'error' : ''; ?>">
				...
				<div class='controls'>
					<select name="pengikut[]" id="pengikut[]" class="chosen-select-no-results" onchange="getinfo(this.value)">
						<option value="">-- Pilih  --</option>
						<?php if (isset($users) && is_array($users) && count($users)):?>
						<?php foreach($users as $rec):?>
							<option value="<?php echo $rec->id?>" <?php if(isset($sppd_jabodetabek['pegawai']))  echo  ($rec->id==$sppd_jabodetabek['pegawai']) ? "selected" : ""; ?>> <?php e(ucfirst($rec->display_name)); ?></option>
