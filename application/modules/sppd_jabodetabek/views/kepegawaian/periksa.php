...
<div class="control-group <?php echo form_error('tanggal_berangkat') ? 'error' : ''; ?> col-sm-6">
			...
			<div class="control-group <?php echo form_error('jam_berangkat') ? 'error' : ''; ?>">
				...
				<div class='controls'>
					<input id='sppd_jabodetabek_jam_berangkat' placeholder="hh:mm" type='text' name='sppd_jabodetabek_jam_berangkat'  value="<?php echo set_value('sppd_jabodetabek_jam_berangkat', isset($sppd_jabodetabek['jam_berangkat']) ? $sppd_jabodetabek['jam_berangkat'] : ''); ?>" />
		   ...
		   <?php 
			...
			?> 
				...
				<div class="control-group <?php echo form_error('status_atasan') ? 'error' : ''; ?>">
					...
					<div class='controls' aria-labelled-by='surat_izin_status_atasan_label'>
						<label class='radio' for='surat_izin_status_atasan_option1'>
							<input id='surat_izin_status_atasan_option1' name='status_atasan' type='radio' class='' value='1' <?php if(isset($sppd_jabodetabek['status_atasan']) and $sppd_jabodetabek['status_atasan']=="1") echo "checked"; ?> />
							Setuju
						</label>
						<br>
						<label class='radio' for='surat_izin_status_atasan_option2'>
							<input id='surat_izin_status_atasan_option2' name='status_atasan' type='radio' class='' value='2' <?php if(isset($sppd_jabodetabek['status_atasan']) and $sppd_jabodetabek['status_atasan']=="2") echo "checked"; ?> />
							Tidak Setuju
						</label>
				...
				<div class="control-group <?php echo form_error('alasan_ditolak') ? 'error' : ''; ?>">
					...
					<div class='controls'> 
						<?php echo form_textarea( array( 'name' => 'alasan_ditolak', 'id' => 'alasan_ditolak', 'rows' => '5', 'cols' => '80', 'value' => set_value('alasan_ditolak', isset($sppd_jabodetabek['alasan_ditolak']) ? $sppd_jabodetabek['alasan_ditolak'] : '') ) ); ?>
			...
			<div class="form-actions">
				...
				<?php echo lang('bf_or'); ?>
				<?php echo anchor(SITE_AREA .'/kepegawaian/sppd_jabodetabek/listsppd', lang('sppd_jabodetabek_cancel'), 'class="btn btn-warning"'); ?>
