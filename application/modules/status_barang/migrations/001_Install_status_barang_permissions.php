...
class Migration_Install_status_barang_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Status_Barang.Masters.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Status_Barang.Masters.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Status_Barang.Masters.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Status_Barang.Masters.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
