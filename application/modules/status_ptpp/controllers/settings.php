...
class settings extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Status_Ptpp.Settings.View');
	...
	public function index()
	{
		...
		Template::set('toolbar_title', 'Manage Status Ptpp');
		Template::render();
	}
	...
	{
		$this->auth->restrict('Status_Ptpp.Settings.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_status_ptpp())
			{
				...
				redirect(SITE_AREA .'/settings/status_ptpp');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Status_Ptpp.Settings.Edit');
		...
		{
			$this->auth->restrict('Status_Ptpp.Settings.Delete');
