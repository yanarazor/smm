...
class Migration_Install_status_pengadaan_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Status_Pengadaan.Masters.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Status_Pengadaan.Masters.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Status_Pengadaan.Masters.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Status_Pengadaan.Masters.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
