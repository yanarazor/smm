...
class Migration_Install_jadwal_audit_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Jadwal_Audit.Audit.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Jadwal_Audit.Audit.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Jadwal_Audit.Audit.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Jadwal_Audit.Audit.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
