...
<div class="admin-box">
	<h3>Jadwal Audit</h3>
	<form action="<?php echo base_url()."index.php/admin/audit/jadwal_audit/saveajax"; ?>" class="form-horizontal" id="frmajax" method="post">
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<div class="control-group <?php echo form_error('pm') ? 'error' : ''; ?>">
				<?php echo form_label('PM/PR/IK'. lang('bf_form_label_required'), 'jadwal_audit_pm', array('class' => 'control-label') ); ?>
				<div class='controls'>
			...
			<div class="form-actions">
				...
				<?php echo lang('bf_or'); ?>
				<?php echo anchor(SITE_AREA .'/audit/jadwal_audit', lang('jadwal_audit_cancel'), 'class="btn btn-warning btnclose"'); ?> 
			</div>
		</fieldset>
    <?php echo form_close(); ?>
</div>
