	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<div class="form-actions">
				<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('jadwal_audit_action_edit'); ?>"  />
				<?php echo lang('bf_or'); ?>
				<?php echo anchor(SITE_AREA .'/audit/jadwal_audit', lang('jadwal_audit_cancel'), 'class="btn btn-warning"'); ?>
				
			<?php if ($this->auth->has_permission('Jadwal_Audit.Audit.Delete')) : ?>
				or
				<button type="submit" name="delete" class="btn btn-danger" id="delete-me" onclick="return confirm('<?php e(js_escape(lang('jadwal_audit_delete_confirm'))); ?>'); ">
					<span class="icon-trash icon-white"></span>&nbsp;<?php echo lang('jadwal_audit_delete_record'); ?>
				</button>
			<?php endif; ?>
			</div>
		</fieldset>
