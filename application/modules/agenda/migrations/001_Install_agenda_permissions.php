...
class Migration_Install_agenda_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Agenda.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Agenda.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Agenda.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Agenda.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
