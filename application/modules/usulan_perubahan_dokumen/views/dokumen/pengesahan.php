...
<div class="admin-box">
	...
	<?php echo form_open_multipart($this->uri->uri_string(), 'class="form-horizontal"'); ?>
			...
			<div class="control-group <?php echo form_error('kode_dokumen') ? 'error' : ''; ?>">
				...
				<div class='controls'>
					<input id='nomor_dok' type='hidden' name='nomor_dok' readonly maxlength="50" value="<?php echo set_value('usulan_perubahan_dokumen_nomor', isset($usulan_perubahan_dokumen['nomor']) ? $usulan_perubahan_dokumen['nomor'] : ''); ?>" />
					...
					<input id='pengajuawal' type='hidden' name='pengajuawal' maxlength="255" />
			...
			<div class="control-group <?php echo form_error('status_periksa') ? 'error' : ''; ?>">
				<?php echo form_label('Status', '', array('class' => 'control-label', 'id' => 'usulan_perubahan_dokumen_status_periksa_label') ); ?>
				<div class='controls'>
				 
					<label class='radio' for='usulan_perubahan_dokumen_status_periksa_option1'>
						<input id='usulan_perubahan_dokumen_status_periksa_option1' name='usulan_perubahan_dokumen_status_periksa' type='radio' value='1' <?php echo $usulan_perubahan_dokumen['status_periksa']=="1" ? "checked" : "" ?> <?php echo set_radio('usulan_perubahan_dokumen_status_periksa', '1'); ?> />
						Ya
					</label>
					</br>
					<label class='radio' for='usulan_perubahan_dokumen_status_periksa_option2'>
						<input id='usulan_perubahan_dokumen_status_periksa_option2' name='usulan_perubahan_dokumen_status_periksa' type='radio' value='0' <?php echo $usulan_perubahan_dokumen['status_periksa']=="0" ? "checked" : "" ?> <?php echo set_radio('usulan_perubahan_dokumen_status_periksa', '0'); ?> />
						Tidak
					</label>
			...
			<div class="control-group <?php echo form_error('status_sah') ? 'error' : ''; ?>">
				<?php echo form_label('Status', '', array('class' => 'control-label', 'id' => 'usulan_perubahan_dokumen_status_sah_label') ); ?>
				<div class='controls'>
					<label class='radio' for='usulan_perubahan_dokumen_status_sah_option1'>
						<input id='usulan_perubahan_dokumen_status_sah_option1' name='usulan_perubahan_dokumen_status_sah' type='radio' class='' value='1' <?php echo $usulan_perubahan_dokumen['status_sah']=="1" ? "checked" : "" ?> <?php echo set_radio('usulan_perubahan_dokumen_status_sah', '1'); ?> />
						Ya
					</label>
					</br>
					<label class='radio' for='usulan_perubahan_dokumen_status_sah_option2'>
						<input id='usulan_perubahan_dokumen_status_sah_option2' name='usulan_perubahan_dokumen_status_sah' type='radio' class='' value='0' <?php echo $usulan_perubahan_dokumen['status_sah']=="0" ? "checked" : "" ?> <?php echo set_radio('usulan_perubahan_dokumen_status_sah', '0'); ?> />
						Tidak
					</label>
				</div>
			</div>
