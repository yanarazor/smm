...
class Migration_Install_usulan_perubahan_dokumen_eksternal_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Usulan_Perubahan_Dokumen_Eksternal.Dokumen.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Usulan_Perubahan_Dokumen_Eksternal.Dokumen.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Usulan_Perubahan_Dokumen_Eksternal.Dokumen.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Usulan_Perubahan_Dokumen_Eksternal.Dokumen.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
