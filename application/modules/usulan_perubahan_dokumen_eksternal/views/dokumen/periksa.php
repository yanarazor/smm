...
<div class="admin-box">
	...
	<?php echo form_open_multipart($this->uri->uri_string(), 'class="form-horizontal"'); ?>
			...
			<div class="form-actions">
				<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('usulan_perubahan_dokumen_eksternal_action_create'); ?>"  />
				<?php echo lang('bf_or'); ?>
				<?php echo anchor(SITE_AREA .'/dokumen/usulan_perubahan_dokumen_eksternal', lang('usulan_perubahan_dokumen_eksternal_cancel'), 'class="btn btn-warning"'); ?>
...
function getinfo(kode){
	...
	var json_url = "<?php echo base_url() ?>index.php/admin/dokumen/dokumen_eksternal/getinfo/?id_dokumen="+data_pengujian_id_pengujian;
