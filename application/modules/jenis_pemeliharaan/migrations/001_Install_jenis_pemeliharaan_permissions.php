...
class Migration_Install_jenis_pemeliharaan_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Jenis_Pemeliharaan.Masters.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Jenis_Pemeliharaan.Masters.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Jenis_Pemeliharaan.Masters.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Jenis_Pemeliharaan.Masters.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
