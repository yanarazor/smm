...
class Migration_Install_tindakan_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Tindakan.Ketidaksesuaian.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Tindakan.Ketidaksesuaian.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Tindakan.Ketidaksesuaian.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Tindakan.Ketidaksesuaian.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
