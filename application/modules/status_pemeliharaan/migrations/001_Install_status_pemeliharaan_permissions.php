...
class Migration_Install_status_pemeliharaan_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Status_pemeliharaan.Masters.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Status_pemeliharaan.Masters.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Status_pemeliharaan.Masters.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Status_pemeliharaan.Masters.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
