...
class Migration_Install_daftar_induk_rekaman_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Daftar_induk_rekaman.Rekaman.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Daftar_induk_rekaman.Rekaman.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Daftar_induk_rekaman.Rekaman.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Daftar_induk_rekaman.Rekaman.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
