...
class Migration_Install_pangkat_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Pangkat.Masters.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Pangkat.Masters.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Pangkat.Masters.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Pangkat.Masters.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
