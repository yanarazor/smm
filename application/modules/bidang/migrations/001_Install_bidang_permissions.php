...
class Migration_Install_bidang_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Bidang.Masters.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Bidang.Masters.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Bidang.Masters.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Bidang.Masters.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
