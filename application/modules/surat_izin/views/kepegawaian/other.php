...
<div class="admin-box">
	...
	<ul class="nav nav-tabs">
		...
		<li<?php echo $filter_type == 'all' ? ' class="active"' : ''; ?>><?php echo anchor(base_url()."index.php/admin/kepegawaian/surat_izin/other", "Usulan"); ?></li>
				...
				<?php endif; ?>
					...
					<td>
						<?php 
							 ...
							 echo $record->status_atasan=="" ? "<span class='label label-warning'>Menunggu Status</span>":"" ;
							echo $record->status_atasan=="0" ? "<span class='label label-warning'>Menunggu Status</span>":"" ;
						?> 
					</td>
