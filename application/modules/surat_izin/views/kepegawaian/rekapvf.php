...
<div class="admin-box">
	...
	<ul class="nav nav-tabs">
	 ...
	 <table>
            ...
            <tr>
            	<td>
                	<input id='user' type='text' name='user' maxlength="20" value="<?php echo set_value('keyword', isset($keyword) ? $keyword : ''); ?>" />
                </td>
                <td>
			...
			<tfoot>
				...
				<tr>
					<td colspan="<?php echo $num_columns; ?>">
						<a href="<?php echo base_url() ?>index.php/admin/kepegawaian/surat_izin/rekapvfxls/<?=$idizin?>/?user=<?=$user?>&bulan=<?=$bulan?>&status=<?=$status?>" class="btn btn-primary"> Download xls </a>
					</td>
				</tr>
