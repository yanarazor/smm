			...
			<div class="control-group <?php echo form_error('izin') ? 'error' : ''; ?>">
				...
				<div class='controls' aria-labelled-by='surat_izin_status_atasan_label'>
					<?php if (isset($masterizins) && is_array($masterizins) && count($masterizins)):?>
					 ...
					 <!--
					<label class='radio' for='surat_izin_status_atasan_option1'>
						<input id='izin_option1' name='izin' type='radio' class='' value='1' <?php if(isset($surat_izin['izin']) and $surat_izin['izin']=="1") echo "checked"; ?> />
						Tidak Masuk Kerja
					</label>
					<br>
					<label class='radio' for='surat_izin_status_atasan_option2'>
						<input id='izin_option2' name='izin' type='radio' class='' value='2' <?php if(isset($surat_izin['izin']) and $surat_izin['izin']=="2") echo "checked"; ?> />
						Izin Pulang Sebelum Waktunya
					</label>
					<br>
					<label class='radio' for='surat_izin_status_atasan_option2'>
						<input id='izin_option3' name='izin' type='radio' class='' value='3' <?php if(isset($surat_izin['izin']) and $surat_izin['izin']=="3") echo "checked"; ?> />
			...
			<div class="control-group <?php echo form_error('surat_izin_satuan') ? 'error' : ''; ?>">
				...
				<div class='controls' aria-labelled-by='surat_izin_status_atasan_label'>
					<label class='radio' for='surat_izin_satuan1'>
						<input id='surat_izin_satuan1' name='surat_izin_satuan' type='radio' class='' value='Hari' <?php if(isset($surat_izin['satuan']) and $surat_izin['satuan']=="Hari") echo "checked"; ?> />
						Hari
					</label>
					<br>
