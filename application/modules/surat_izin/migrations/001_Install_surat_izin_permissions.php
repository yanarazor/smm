...
class Migration_Install_surat_izin_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Surat_Izin.Kepegawaian.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Surat_Izin.Kepegawaian.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Surat_Izin.Kepegawaian.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Surat_Izin.Kepegawaian.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
