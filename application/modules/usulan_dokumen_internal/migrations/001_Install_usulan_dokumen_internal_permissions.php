...
class Migration_Install_usulan_dokumen_internal_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Usulan_Dokumen_Internal.Dokumen.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Usulan_Dokumen_Internal.Dokumen.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Usulan_Dokumen_Internal.Dokumen.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Usulan_Dokumen_Internal.Dokumen.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
