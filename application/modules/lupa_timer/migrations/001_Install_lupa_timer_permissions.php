...
class Migration_Install_lupa_timer_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Lupa_Timer.Kepegawaian.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Lupa_Timer.Kepegawaian.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Lupa_Timer.Kepegawaian.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Lupa_Timer.Kepegawaian.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
