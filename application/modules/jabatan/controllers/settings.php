...
class settings extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Jabatan.Settings.View');
	...
	{
		$this->auth->restrict('Jabatan.Settings.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_jabatan())
			{
				...
				redirect(SITE_AREA .'/settings/jabatan');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Jabatan.Settings.Edit');
		...
		{
			$this->auth->restrict('Jabatan.Settings.Delete');
