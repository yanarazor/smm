...
class Migration_Install_t_mak_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'T_mak.Masters.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'T_mak.Masters.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'T_mak.Masters.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'T_mak.Masters.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
