...
<div class="admin-box">
   ...
   <div class="alert alert-block alert-warning fade in ">
      <a class="close" data-dismiss="alert">&times;</a>
       ...
       <a class="btn btn-success pull-right" target="_blank" title="Refresh data SAS" href="<?php echo base_url(); ?>admin/kepegawaian/absen/downloadlist?nip=<?php echo $nip ?>&nama=<?php echo $nama ?>&tgl=<?php echo $tgl ?>&bulan=<?php echo $bulan ?>&tahun=<?php echo $tahun ?>"><i class="fa fa-download" aria-hidden="true"></i> Download .xls</a>
    </div>
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/kepegawaian/absen/edit/', '<span class="icon-pencil"></span>' .  $record->nik); ?></td>
				<?php else : ?>
