...
class Migration_Install_absen_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Absen.Kepegawaian.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Absen.Kepegawaian.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Absen.Kepegawaian.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Absen.Kepegawaian.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
